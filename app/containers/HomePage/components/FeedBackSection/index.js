...
export default class FeedBackSection extends React.PureComponent { // eslint-disable-line
    render() {
        return (
            <StyledContainer>
                <StyledTitle>
                ...
                <Carousel showThumbs={false} showIndicators={false} showStatus={false} autoPlay transitionTime={800} interval={7500} stopOnHover={false} infiniteLoop>
                    ...
                    <StyledTextContainer>
                        <StyledText>«До обращения к Тане и Алексею мне казалось моя ситуация безысходна, адвокаты сразу обрисовали перспективу,проработали стратегию, результат – мировое соглашение на условиях о которых я даже не могла и мечтать. Благодарна от всей души!» </StyledText>
                    </StyledTextContainer>
                    <StyledTextContainer>
                    ...
                    <StyledTextContainer>
                        <StyledText>«Обратились к Алексею и Татьяне с будущим супругом по рекомендации. Желали, чтобы у нас было все оговорено еще на берегу.Теперь мы застрахованы и, наверное, самая крепкая семья, которой ничего не страшно.».</StyledText>
                    </StyledTextContainer>
                    <StyledTextContainer>
